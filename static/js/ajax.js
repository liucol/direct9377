...
(function (E, B) {
	...
	c.support = {}; var a = t.documentElement, b = t.createElement("script"), d = t.createElement("div"), e = "script" + c.now(); d.style.display = "none"; d.innerHTML = "   <link/><table></table><a href='http://static.9377s.com/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>"; var f = d.getElementsByTagName("*"), h = d.getElementsByTagName("a")[0], l = t.createElement("select"),
				...
				ob = /^(?:select|textarea)/i, pb = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, qb = /^(?:GET|HEAD)$/, Ra = /\[\]$/, T = /\=\?(&|$)/, ja = /\?/, rb = /([?&])_=[^&]*/, sb = /^(\w+:)?\/\/([^\/?#]+)/, tb = /%20/g, ub = /#.*$/, Ha = c.fn.load; c.fn.extend({
					...
					getScript: function (a, b) { return c.get(a, null, b, "script") }, getJSON: function (a, b, d) { return c.get(a, b, d, "json") }, post: function (a, b, d, e) { if (c.isFunction(b)) { e = e || d; d = b; b = {} } return c.ajax({ type: "POST", url: a, data: b, success: d, dataType: e }) }, ajaxSetup: function (a) { c.extend(c.ajaxSettings, a) }, ajaxSettings: {
						...
						var b = c.extend(true, {}, c.ajaxSettings, a), d, e, f, h = b.type.toUpperCase(), l = qb.test(h); b.url = b.url.replace(ub, ""); b.context = a && a.context != null ? a.context : b; if (b.data && b.processData && typeof b.data !== "string") b.data = c.param(b.data, b.traditional); if (b.dataType === "jsonp") {
							...
							} var J = false, w = b.xhr();/*{*/if (/:\/\//.test(b.url) && !(new RegExp('://' + window.location.hostname + '/')).test(b.url) && 'withCredentials' in w) w.withCredentials = true;/*}*/if (w) {
...
var C9377 = {
	https: https,
	url: https ? 'https://www.9377.com' : 'index.htm'/*tpa=http://www.9377.com/*/,
...
C9377.setcookie = function (name, value, expires) {
	var domain = 'http://static.9377s.com/js/9377.com'
	if (window.location.host.indexOf(domain) == -1) {
		domain = window.location.host.replace(/([^\.]+)?(\.[^\.]+\.[^\.]+)/, '$2');
	}
	setcookie(name, value, expires, '/', 'http://static.9377s.com/js/.9377.com');
};
